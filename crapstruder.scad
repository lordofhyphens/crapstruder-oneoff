...
difference()
{
  ...
  translate([(-41/2)+25,45/2+center_hole_offset_x+ +20,center_hole_offset_z])rotate([90,0,0]) cylinder(r=1.3,h=500,$fs=.2); // feed hole
  translate([0,0,-5])cylinder(r=22/2,h=26);
}
translate([(-41/2)+25,45/2-.6,center_hole_offset_z])rotate([-90,90,0]) 
{
